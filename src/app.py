...
activities = {
    ...
    "Basketball Team": {
        ...
        "max_participants": 15,
        "participants": ["kyle@mergington.edu", "rachel@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Open soccer practices and friendly matches",
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["lucy@mergington.edu", "harry@mergington.edu"]
    },
    "Drama Society": {
        "description": "Rehearse and perform plays and theatrical pieces",
        "schedule": "Fridays, 4:00 PM - 6:30 PM",
        "max_participants": 25,
        "participants": ["sara@mergington.edu", "yara@mergington.edu"]
    },
    "Science Club": {
    ...
    "Debate Team": {
        "description": "Research issues and compete in structured debates",
